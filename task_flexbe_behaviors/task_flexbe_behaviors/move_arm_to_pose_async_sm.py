...
In case of using current joint as start joints, just set the input start joints to any
    ...
    def create(self):
        ...
        _state_machine = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['target_pose', 'translation_list', 'start_joints', 'velocity'], output_keys=['target_joints'])
