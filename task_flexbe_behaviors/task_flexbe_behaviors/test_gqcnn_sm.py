    ...
    def create(self):
        ...
        with _state_machine:
            ...
            OperatableStateMachine.add('release_marker_occupy_and_stop_timmer',
                                        ImgMaskingClientState(namespace='', marker_id=15, create_depth_mask=False, update_mask=False, start_update_timer=False, stop_update_timer=False, mark_release=True, get_masked_img=False, resolution_wide=516, resolution_high=386),
