    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=[
                ...
                'YAML:joint_names:=mm_flexbe_behaviors/config/multi_arm_planning.yaml:joint_names',
                'YAML:random_areas:=mm_flexbe_behaviors/config/multi_arm_planning.yaml:random_areas',
                'YAML:using_areas:=mm_flexbe_behaviors/config/multi_arm_planning.yaml:using_areas',
            ],
            output="screen",
        )
    ])
